...
static uint16_t tim1_period_ticks = ARR_16K;
...
{
    {  12U,   12U, 12000U }, // 0.10% -> 0.50us @ 2.00kHz
    {  24U,   24U, 12000U }, // 0.20% -> 1.00us @ 2.00kHz
    {  36U,   36U, 12000U }, // 0.30% -> 1.50us @ 2.00kHz
    {  60U,   60U, 12000U }, // 0.50% -> 2.50us @ 2.00kHz
    { 120U,  120U, 12000U }, // 1.00% -> 5.00us @ 2.00kHz
    { 240U,  240U, 12000U }, // 2.00% -> 10.0us @ 2.00kHz
    { 300U,  300U, 12000U }, // 2.50% -> 12.5us @ 2.00kHz
    { 360U,  300U, 10000U }, // 3.00% -> 12.5us @ 2.40kHz
    { 600U,  300U,  6000U }, // 5.00% -> 12.5us @ 4.00kHz
    { 960U,  300U,  3750U }, // 8.00% -> 12.5us @ 6.40kHz
    {1200U,  300U,  3000U }, // 10.0% -> 12.5us @ 8.00kHz
    {1440U,  300U,  2500U }, // 12.0% -> 12.5us @ 9.60kHz
    {1920U,  300U,  1875U }, // 16.0% -> 12.5us @ 12.8kHz
    {2400U,  300U,  1500U }, // 20.0% -> 12.5us @ 16.00kHz
    {2765U,  346U,  1500U }, // 23.04% -> 14.4us @ 16.00kHz
    {11328U, 1416U, 1500U }, // 94.40% -> 59.0us @ 16.00kHz
    {12000U, 1490U, 1500U }, // 100.0% -> max output
};
...
void app_set_manual_level(uint8_t level)
{
    ...
    pwm_duty_tag = (uint16_t)level * 120U;
    pwm_duty2_tag = pwm_duty_tag;
}
